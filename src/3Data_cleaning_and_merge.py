...
columns_to_convert2 = ["Name", "Top-level family", "ISO-639-3", "Glottocode", "Macroarea"]
...
df_final = pd.merge(df1, df2, how="right", on="Glottocode", sort=False, validate="many_to_one")
