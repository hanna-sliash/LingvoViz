...
header_component = html.H1(
    "LingvoViz - Languages of the World Dashboard",
            ...
            [
                html.P(
                    [
                        "There are ",
                        html.Span(
                            f"{transform_number(total_count_lang)}",
                            style={
                                "fontSize": "20px",
                                "fontWeight": "bold",
                                "color": "#1f77b4",
                ...
                html.P(
                    [
                        "There are only ",
                        html.Span(
                            f"{transform_number(safe_lang_count)}",
                            style={
                                "fontSize": "20px",
                                "fontWeight": "bold",
                                "color": "#1f77b4",
                ...
                html.P(
                    [
                        ...
                        html.Span(
                            f"{transform_number(endang_lang_count)}",
                            style={
                                "fontSize": "20px",
                                "fontWeight": "bold",
                                "color": "#1f77b4",
                ...
                html.P(
                    [
                        html.Span(
                            f"{transform_number(lost_lang_count)}",
                            style={
                                "fontSize": "20px",
                                "fontWeight": "bold",
                                "color": "#1f77b4",
...
fig1.update_layout(
    showlegend=False, hovermode="closest", margin=dict(l=50, r=50, t=50, b=50)
)
...
fig2.update_traces(textposition="middle center", textfont_size=10)
